		  					...
		  					<div class="panel-body">
		  						<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
									...
									<?php foreach ($job_id as $index => $job): ?> 
										<tr>
											<td><a href="editRow.html"><?php echo $job; ?></td>
									        <td><?php echo $job_location[$index]; ?></td>
									        <td><?php echo $job_description[$index]; ?></td>
									        <td><?php echo $job_notes[$index]; ?></td>
									        <!--
									        <td class="sui-cell sui-editable-cell">
									        	<span class=" sui-textbox">
									        		<input value='<?php echo $job_notes[$index]; ?>' style="display: none;">
									        		<input type="text" class="sui-input">
									        		<span class="sui-spinners">...</span>
									        	</span>
									        </td>
									        -->
